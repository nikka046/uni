...
class QuizTest {
  ...
  void allRight() {
    Integer[] randoms = {};
    String inputs[] = { new String("FDR"), new String("32"), new String("New York"), new String("1929"),
        new String("Eleanor"), new String("6"), new String("Harvard"), new String("Theodore"), new String("Polio"),
        new String("63") };
  ...
  void oneWrong() {
    Integer[] randoms = {};
    String inputs[] = { new String("Frankie"), new String("32"), new String("New York"), new String("1929"),
        new String("Eleanor"), new String("6"), new String("Harvard"), new String("Theodore"), new String("Polio"),
        new String("63") };
